...
def main(
    ...
    if not items:
        print("No labeled recognizability images found.")
        return
    ...
    torch.save(
        ...
        out_dir / "recognizability_gate.pt",
    )
    with open(out_dir / "recognizability_gate_metrics.json", "w") as f:
        json.dump(metrics, f, indent=2)
    with open(out_dir / "recognizability_gate_meta.json", "w") as f:
        json.dump(
            {
    ...
    print("Saved model to", out_dir / "recognizability_gate.pt")
    print("Saved metrics to", out_dir / "recognizability_gate_metrics.json")


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--labeled-dir", default="data/labeled_recognizability")
    parser.add_argument("--out-dir", default="data/models/recognizability_gate")
    parser.add_argument("--labels", default="recognizable,unrecognizable,bad_image")
