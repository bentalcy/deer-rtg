...
def main(pool_dir: Path, model_path: Path, out_csv: Path, batch_size: int) -> None:
    ...
    print("Wrote recognizability scores to", out_csv)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--pool-dir", default="data/pool/crops")
    parser.add_argument("--model-path", default="data/models/recognizability_gate/recognizability_gate.pt")
    parser.add_argument("--out-csv", default="data/active_learning/recognizability_scores.csv")
